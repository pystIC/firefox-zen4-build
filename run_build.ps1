...
$env:MOZCONFIG = "C:\Users\Devin\.gemini\antigravity\scratch\mozilla-source\mozconfig"
Set-Location -Path "C:\Users\Devin\.gemini\antigravity\scratch\mozilla-source"
